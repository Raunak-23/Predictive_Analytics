...
│   ├── infer.py                                 <- CLI Inference Tool for Custom Data & Customer Queries
...
5. **Run CLI Inference on Custom Data or Saved Models**:
   ```powershell
   python src/infer.py --dataset d1 --user 12349 --top-k 10
   python src/infer.py --data path/to/my_transactions.csv --top-k 10
   ```
