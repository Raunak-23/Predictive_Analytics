...
def prepare_instacart_dataset(
    raw_dir: Optional[Path] = None,
    out_csv: Optional[Path] = None,
    sample_users_count: int = 1000,
) -> Path:
    """Extract and merge Instacart relational tables into canonical transaction CSV."""
    if raw_dir is None:
    ...
    sample_users = train_orders["user_id"].unique()[:sample_users_count]
