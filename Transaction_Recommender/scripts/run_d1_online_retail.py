...
def run_d1_pipeline() -> None:
    ...
    print(f"  Candidate Recall: {cand_rec:.4f} ({cand_rec*100:.2f}%)")
    print(f"  Users with 100% Future Items in Candidates: {pct_fully_covered}%")
    ...
    # Train final Random Forest using selected parameters
    print("\n  Fitting Selected Random Forest Model...")
    ...
    # -------------------------------------------------------------------------
    print("\n[Stage 9] Evaluating Popularity Baseline and Random Forest on Locked Test Window...")
    # Features for test evaluation: strictly before val_end (train_hist + val_future)
